...
class PackageBuilderTests(unittest.TestCase):
    def test_package_contains_employer_files_but_not_internal_intelligence(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            for path, text in ((cv, "Executive support and calendar management"), (cover, "Dear Hiring Team")):
            ...
            job = Job("Example Ltd", "Executive Assistant", "Remote", "test", "https://example.test/job")
